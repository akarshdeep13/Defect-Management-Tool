...
<form name=f1 action=edit_defect.jsp>
<input type="text" style="width: 20%" id="js-search" placeholder="Search Here To Filter !!!"> 
<button type ="submit" class="signupbtn" style="float:right;">Edit</button>
<button type ="submit" class="signupbtn" style="float:right;" formaction="Export.jsp">Export</button>
