...
<form name = f1 method ="post" action="create_defect.jsp" style= "border:1px solid #ccc">
<div class="container">
<h1>Create Defect</h1>
<hr>
<center>
<table >
<tr>
<td><label>Defect ID <font color="red">*</font></label></td><td><input type = "tel" minlength="7" maxlength="7" placeholder="Enter Defect ID" name="defect_id" style="width:100%;" required readonly value="<%=did+1%>"></td>
<td><label for="Db">&nbsp;&nbsp;Defected By<font color="red">*</font></label></td><td><input type="text"  name="Defected_by" style="width:100%;" value="<%=id%>" readonly></td></tr>
   ...
   <td>	<select name="Defect_type" required style="width:100%;">
    ...
    <td><input type="date" min=<%=past %> max=<%=today %> name="Defect_date" placeholder="Enter Defect Date" style="width:100%;" required></td></tr>
