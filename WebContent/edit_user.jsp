...
<form name= f1 method="post" action="modify_user.jsp">
...
<td width="165"><input type="textarea" name="first_name" value="<%=resultSet.getString("first_name") %>"></td>
<td width="165"><input type="textarea" name="last_name" value="<%=resultSet.getString("last_name") %>"></td>
<td width="165"><input type="textarea" name="password" value="<%=resultSet.getString("password") %>"></td>
<td width="95"><select id="role" name="role" style="width:100%;">
      <option value="<%=resultSet.getString("roles") %>"><%=resultSet.getString("roles") %></option>
      <option value="Administrator">Administrator</option>
      <option value="Developer">Developer</option>
      <option value="Tester">Tester</option>
              </select></td>
<td width="95"><select id="status" name="status" style="width:100%;">
