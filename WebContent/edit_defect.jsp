...
<form name=f1 action=modify_defect.jsp>
...
for(int a=0;a<20;a++)
{
String sql ="select * from create_defect where defect_id="+idi[a]+" ORDER BY defect_date DESC";
...
<td width="100">  <select id="status" name="status" style="width:100%">
